...
from .whole_brain_context_packaging import (
...
from .whole_brain_context_session_query import (
    ...
    discover_showcase_handoff_links as _discover_showcase_handoff_links,
...
def resolve_whole_brain_context_session_plan(
    *,
    ...
    query_session = execute_whole_brain_context_session_queries(
    ...
    query_execution = copy.deepcopy(dict(query_session["query_execution"]))
    query_preset_library = copy.deepcopy(dict(query_session["query_preset_library"]))
    ...
    package_contents = build_whole_brain_context_session_package_contents(
        plan_version=WHOLE_BRAIN_CONTEXT_SESSION_PLAN_VERSION,
    ...
    return {
        ...
        "context_view_payload": copy.deepcopy(package_contents["context_view_payload"]),
        "context_query_catalog": copy.deepcopy(package_contents["context_query_catalog"]),
        "context_view_state": copy.deepcopy(package_contents["context_view_state"]),
        "output_locations": copy.deepcopy(package_contents["output_locations"]),
...
def package_whole_brain_context_session(plan: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return package_whole_brain_context_session_bundle(normalized_plan)

...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run the Milestone 12 task-layer integration verification pass and publish a readiness report."
    )
    parser.add_argument(
        "--config",
        required=True,
        help="Path to the YAML config file that defines the local Milestone 12 verification outputs.",
    )
    parser.add_argument(
        "--fixture-test-target",
        action="append",
        ...
        default=[],
        help="Optional unittest target to add to the focused Milestone 12 verification suite. Repeatable.",
    )
    parser.add_argument(
        "--skip-fixture-tests",
        action="store_true",
        help="Skip the focused Milestone 12 fixture verification suite.",
    )
    parser.add_argument(
        "--open-visualization",
        action="store_true",
    ...
    summary = execute_milestone12_readiness_pass(

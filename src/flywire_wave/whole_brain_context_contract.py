    ...
    return [
        {
            **build_whole_brain_context_reduction_profile_definition(
            ...
            "max_hops": 0,
            "edge_ranking_policy": "synapse_count_desc",
            "pathway_edge_ranking_policy": "synapse_count_desc",
            "pathway_extraction_mode": "top_ranked_paths",
            "allowed_neuropils": [],
        ...
        },
        {
            **build_whole_brain_context_reduction_profile_definition(
            ...
            "max_hops": 3,
            "edge_ranking_policy": "weighted_synapse_desc",
            "pathway_edge_ranking_policy": "weighted_synapse_desc",
            "pathway_extraction_mode": "top_ranked_paths",
            "allowed_neuropils": [],
            "allowed_cell_classes": [],
            "pathway_target_root_ids": [],

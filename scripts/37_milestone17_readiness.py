...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Run the Milestone 17 whole-brain-context integration verification "
    ...
    parser.add_argument(
        "--config",
        required=True,
        help="Path to the YAML config file that defines the local Milestone 17 verification outputs.",
    )
    parser.add_argument(
        "--fixture-test-target",
        action="append",
        ...
        default=[],
        help="Optional unittest target to add to the focused Milestone 17 verification suite. Repeatable.",
    )
    parser.add_argument(
        "--skip-fixture-tests",
        action="store_true",
        help="Skip the focused Milestone 17 whole-brain-context fixture verification suite.",
    )
    ...
    summary = execute_milestone17_readiness_pass(
        ...
        json.dumps(
            {
                ...
                "whole_brain_context_metadata_path": summary["context_review_audit"][
                    "metadata_path"
                ],
                "dashboard_session_metadata_path": summary["dashboard_audit"][
                    "metadata_path"
                ],
            },
            indent=2,
